...
interface TaskTabsAdminProps {
  onOpenModal: () => void;
  title: string;
}

const TaskTabsAdmin: React.FC<TaskTabsAdminProps> = ({ onOpenModal, title }) => {
      ...
      <div className="flex flex-row items-center gap-4 justify-start w-full">
        <div className="tabs bg-[#F4F4F5] rounded-[10px] p-1">
          <a
            ...
            onClick={() => handleTabChange("/admin-kanban")}
          >
            Задачи
          </a>
          <a
